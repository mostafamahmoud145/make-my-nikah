...
class Dependencies {
  ...
  final TextStyle textStyle = const TextStyle(fontSize: 15.0, color:Color.fromARGB(225, 225, 225, 225),fontFamily: "Bebas Neue");
...
class TimerTextState extends State<TimerText> {
  ...
  Widget build(BuildContext context) {
    return new MinutesAndSeconds(dependencies: dependencies!);
