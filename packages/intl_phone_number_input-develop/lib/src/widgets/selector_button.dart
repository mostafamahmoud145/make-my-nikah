  ...
  Future<Country?> showCountrySelectorDialog(
    ...
    return showDialog(
      ...
      builder: (BuildContext context) => AlertDialog(
        surfaceTintColor: isWeb == true ? Color.fromRGBO(247, 247, 247, 1.0) : Colors.white,
        backgroundColor: isWeb == true ? Color.fromRGBO(247, 247, 247, 1.0) : Colors.white,
        insetPadding: EdgeInsets.symmetric(horizontal: 24),
        content: Directionality(
          textDirection: Directionality.of(inheritedContext),
          child: Container(
            width: isWeb == true ? 1006 : double.maxFinite,
            height: isWeb == true ? 803 : 500,
